...
public class LiveEntity : GeoGroObject
{
    ...
    //??ｿｽ?ｿｽﾌ力ゑｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ轤ｵ??ｿｽ?ｿｽA??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽG??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽﾔゑｿｽt??ｿｽ?ｿｽ^
    ...
    //??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽﾎゑｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ
    ...
    //??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽﾄゑｿｽ??ｿｽ?ｿｽ驍ｩ
    public bool IsLive()
    {
        return life > 0;
    }
    ...
    //??ｿｽ?ｿｽZ??ｿｽ?ｿｽﾉゑｿｽ髢ｳ??ｿｽ?ｿｽG??ｿｽ?ｿｽ??ｿｽ?ｿｽﾔゑｿｽ
    ...
    //??ｿｽ?ｿｽ_??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ[??ｿｽ?ｿｽW??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽt??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽﾔゑｿｽ
    public bool IsDamageTakeable()
    {
        return !IsShield() && !IsGhostTime();
    }
    //??ｿｽ?ｿｽs??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽﾅゑｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽﾔゑｿｽ
    ...
    //??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽLiveEntity??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽﾊ会ｿｽ??ｿｽ?ｿｽ??ｿｽ?ｿｽﾂらす
